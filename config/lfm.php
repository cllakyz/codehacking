...
return [
    ...
    */
    ...
    // If true, share front will be created when allow_multi_user is true.
    ...
    // Ex: The private front of user will be named as the user id.
    ...
    */
    ...
    // Which front to store files in project, fill in 'public', 'resources', 'storage' and so on.
    ...
    */
    ...
    // If true, non-alphanumeric front name will be rejected.
    ...
    // permissions to be set when create a new front or when it creates automatically with thumbnails
